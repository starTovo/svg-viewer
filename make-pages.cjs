...
<!-- Inline SVG favicon (data URI). Avoids a stray /favicon.ico 404 on Pages
     and gives the tab a real icon. Percent-encoded: # -> %23, < > kept raw
     for readability is unsafe, so they are %3C/%3E, spaces are %20. -->
<link rel="icon" href="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2032%2032'%3E%3Crect%20width='32'%20height='32'%20rx='7'%20fill='%235E6AD2'/%3E%3Cpath%20d='M8,22C8,12%2024,20%2024,10'%20fill='none'%20stroke='white'%20stroke-width='2.6'%20stroke-linecap='round'/%3E%3Ccircle%20cx='8'%20cy='22'%20r='3'%20fill='white'/%3E%3Ccircle%20cx='24'%20cy='10'%20r='3'%20fill='white'/%3E%3C/svg%3E">
<style>
  :root{
